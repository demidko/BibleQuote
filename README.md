...
Библии 1876 года (RST), по аналогии с общепринятым на западе переводом KJV. Номера некоторых глав между этими переводами
могут отличаться на ±1. Синодальным этот перевод называется потому что был сделан Синодом православной церкви, 
...
4. [Unbound Bible](https://github.com/vrybant/unboundbible) — стабильное кроссплатформенное приложение для ПК, однако
   поиск слабее чем в BibleQuote. Примечательно, что используется текст Синодального перевода
